 ...
 * This class runs on the port 9400 and can be connected to by hitting the following URL
 * "rmi://localhost:9400/testserver4"
 */
public class TestServer4
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            LocateRegistry.createRegistry(Constants.portNode4);
            Naming.rebind(Constants.node4, phaseOperation);
            System.out.println("Connection successful to server 4");
        }
        catch (Exception e)
        {
