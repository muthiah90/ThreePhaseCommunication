 ...
 * between processes
 */
public class SwingPhaseClient3
{
    ...
    public static void SendMessage(JTextField msg, JTextField dest, PhaseOperationInterface phaseOpr)
    {
        ...
        {
            System.out.println("Exception in client 3 message thread");
        }
    }
    ...
    {
        String message = "MessageFrom_3_" + String.valueOf(callNumber++);
        ...
        {
            System.out.println("Exception in client 3 ThreadSend Function");
        }
    }
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            timer.schedule(new SwingPhaseClient3.DisplayTasker(phaseOperation, receivedMessages), 0, 100);
            timer.schedule(new SwingPhaseClient3.ReceiveMessage(phaseOperation), 0, 100);
