 ...
 * Server 4 and hence will use the URL "rmi://localhost:9400/testserver4"
 *
 ...
 * between processes
 */
public class SwingPhaseClient4
{
    private static final int clientNumber = 4;
    ...
    static class DisplayTasker extends TimerTask
    {
        ...
        public void run()
        {
            ...
            {
                System.out.println("Exception occurred in thread execution in Client 4");
    ...
    public static void SendMessage(JTextField msg, JTextField dest, PhaseOperationInterface phaseOpr)
    {
        ...
        {
            System.out.println("Exception in client 4 message thread");
        }
    }
    ...
    {
        String message = "MessageFrom_4_" + String.valueOf(callNumber++);
        ...
        {
            System.out.println("Exception in client 4 ThreadSend Function");
        }
    }
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            //Binding with the server4
            PhaseOperationInterface phaseOperation = (PhaseOperationInterface)Naming.lookup(Constants.node4);
            System.out.println("Connected the test server 4");
            ...
            timer.schedule(new SwingPhaseClient4.DisplayTasker(phaseOperation, receivedMessages), 0, 100);
            timer.schedule(new SwingPhaseClient4.ReceiveMessage(phaseOperation), 0, 100);
        ...
        {
            System.out.println(e);
            System.out.println("Exception occurred in Client 4");
        }
    }
}
