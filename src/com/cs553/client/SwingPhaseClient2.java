 ...
 * Server 2 and hence will use the URL "rmi://localhost:9200/testserver2"
 *
 ...
 * between processes
 */
public class SwingPhaseClient2
{
    private static final int clientNumber = 2;
    ...
    static class DisplayTasker extends TimerTask
    {
        ...
        public void run()
        {
            ...
            {
                System.out.println("Exception occurred in thread execution in Client 2");
    ...
    public static void SendMessage(JTextField msg, JTextField dest, PhaseOperationInterface phaseOpr)
    {
        ...
        {
            System.out.println("Exception in client 2 message thread");
        }
    }
    ...
    {
        String message = "MessageFrom_2_" + String.valueOf(callNumber++);
        ...
        {
            System.out.println("Exception in client 2 ThreadSend Function");
        }
    }
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            //Binding with the server2
            PhaseOperationInterface phaseOperation = (PhaseOperationInterface)Naming.lookup(Constants.node2);
            System.out.println("Connected the test server 2");
            ...
            timer.schedule(new SwingPhaseClient2.DisplayTasker(phaseOperation, receivedMessages), 0, 100);
            timer.schedule(new SwingPhaseClient2.ReceiveMessage(phaseOperation), 0, 100);
        ...
        {
            System.out.println(e);
            System.out.println("Exception occurred in Client 2");
        }
    }
}
