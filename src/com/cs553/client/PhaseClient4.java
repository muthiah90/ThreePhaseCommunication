...
public class PhaseClient4
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            timer.schedule(new PhaseClient4.DisplayTasker(phaseOperation), 0, 100);
            timer.schedule(new PhaseClient4.ReceiveMessage(phaseOperation), 0, 100);
